...
tegrastats_thread = subprocess.Popen(["sudo python3 ~/geepafs/tegrastats.py"], stdout=subprocess.STDOUT, stderr=subprocess.STDOUT)


# run geepafs
print("start dvfs")
dvfs_thread = subprocess.Popen(["sudo ./dvfs mod Assure p90"], stdout=subprocess.STDOUT, stderr=subprocess.STDOUT, shell=True)
